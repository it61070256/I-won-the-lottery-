...
def main():
    """Print Last Two lottery graph (The Tens)"""
    bargraph()
...
def bargraph():
    ...
    plt.bar(lis_x, First_pos, color="mediumaquamarine", edgecolor='black', capsize=7, label='number')
    plt.title("เลขท้าย2ตัว\nหลักหน่วย", fontname='JasmineUPC', fontsize=25,)
    plt.xlabel("หมายเลขที่ออก", fontname='JasmineUPC', fontsize='20', color="dodgerblue")
    plt.ylabel("จำนวนครั้งที่ออก", fontname='JasmineUPC', fontsize='20', color="red")
